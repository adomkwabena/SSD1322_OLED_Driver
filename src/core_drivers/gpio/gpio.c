...
static inline void led_gpio_init(void)
{
    ...
    // Configure PD12, PD13, PD14 & PD15 as output I/O.
    ...
    // Configure PD12, PD13, PD14 & PD15 as very high speed I/O.
...
void gpio_init(void)
{
    // Initialize GPIOs connected to LEDs.
    led_gpio_init();
}